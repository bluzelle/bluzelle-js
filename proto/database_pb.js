...
goog.exportSymbol('proto.database_subscribe', null, global);
goog.exportSymbol('proto.database_unsubscribe', null, global);
 ...
 * @const
 */
proto.database_msg.oneofGroups_ = [[10,11,12,13,14,15,16,17,18]];
...
proto.database_msg.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    subscribe: (f = msg.getSubscribe()) && proto.database_subscribe.toObject(includeInstance, f),
    unsubscribe: (f = msg.getUnsubscribe()) && proto.database_unsubscribe.toObject(includeInstance, f)
  };
...
proto.database_msg.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 16:
      ...
      break;
    case 17:
      var value = new proto.database_subscribe;
      reader.readMessage(value,proto.database_subscribe.deserializeBinaryFromReader);
      msg.setSubscribe(value);
      break;
    case 18:
      var value = new proto.database_unsubscribe;
      reader.readMessage(value,proto.database_unsubscribe.deserializeBinaryFromReader);
...
proto.database_msg.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      17,
      f,
      proto.database_subscribe.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      18,
      f,
      proto.database_unsubscribe.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional database_subscribe subscribe = 17;
 * @return {?proto.database_subscribe}
 */
proto.database_msg.prototype.getSubscribe = function() {
  return /** @type{?proto.database_subscribe} */ (
    jspb.Message.getWrapperField(this, proto.database_subscribe, 17));
};


/** @param {?proto.database_subscribe|undefined} value */
proto.database_msg.prototype.setSubscribe = function(value) {
  jspb.Message.setOneofWrapperField(this, 17, proto.database_msg.oneofGroups_[0], value);
};


proto.database_msg.prototype.clearSubscribe = function() {
 ...
 * @return {!boolean}
 */
proto.database_msg.prototype.hasSubscribe = function() {
  return jspb.Message.getField(this, 17) != null;
};


/**
 * optional database_unsubscribe unsubscribe = 18;
 * @return {?proto.database_unsubscribe}
 */
proto.database_msg.prototype.getUnsubscribe = function() {
  return /** @type{?proto.database_unsubscribe} */ (
    jspb.Message.getWrapperField(this, proto.database_unsubscribe, 18));
};


/** @param {?proto.database_unsubscribe|undefined} value */
proto.database_msg.prototype.setUnsubscribe = function(value) {
  jspb.Message.setOneofWrapperField(this, 18, proto.database_msg.oneofGroups_[0], value);
};


proto.database_msg.prototype.clearUnsubscribe = function() {
 ...
 * @return {!boolean}
 */
proto.database_msg.prototype.hasUnsubscribe = function() {
 ...
 * @constructor
 */
proto.database_subscribe = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.database_subscribe, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.database_subscribe.displayName = 'proto.database_subscribe';
}
 ...
 * @return {!Object}
 */
proto.database_subscribe.prototype.toObject = function(opt_includeInstance) {
  return proto.database_subscribe.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.database_subscribe} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.database_subscribe.toObject = function(includeInstance, msg) {
  var f, obj = {
    key: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * @return {!proto.database_subscribe}
 */
proto.database_subscribe.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.database_subscribe;
  return proto.database_subscribe.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.database_subscribe} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.database_subscribe}
 */
proto.database_subscribe.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.database_subscribe.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.database_subscribe.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.database_subscribe} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.database_subscribe.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getKey();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.database_subscribe.prototype.getKey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.database_subscribe.prototype.setKey = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @constructor
 */
proto.database_unsubscribe = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.database_unsubscribe, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.database_unsubscribe.displayName = 'proto.database_unsubscribe';
}
 ...
 * @return {!Object}
 */
proto.database_unsubscribe.prototype.toObject = function(opt_includeInstance) {
  return proto.database_unsubscribe.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.database_unsubscribe} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.database_unsubscribe.toObject = function(includeInstance, msg) {
  var f, obj = {
    key: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * @return {!proto.database_unsubscribe}
 */
proto.database_unsubscribe.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.database_unsubscribe;
  return proto.database_unsubscribe.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.database_unsubscribe} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.database_unsubscribe}
 */
proto.database_unsubscribe.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.database_unsubscribe.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.database_unsubscribe.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.database_unsubscribe} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.database_unsubscribe.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getKey();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.database_unsubscribe.prototype.getKey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.database_unsubscribe.prototype.setKey = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};
...
/**
 * optional database_update update = 9;
 * @return {?proto.database_update}
 */
proto.database_response.response.prototype.getUpdate = function() {
  return /** @type{?proto.database_update} */ (
    jspb.Message.getWrapperField(this, proto.database_update, 9));
};


/** @param {?proto.database_update|undefined} value */
proto.database_response.response.prototype.setUpdate = function(value) {
  jspb.Message.setWrapperField(this, 9, value);
};


proto.database_response.response.prototype.clearUpdate = function() {
  this.setUpdate(undefined);
};
 ...
 * @return {!boolean}
 */
proto.database_response.response.prototype.hasUpdate = function() {
